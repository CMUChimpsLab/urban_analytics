...
relnames_in_order = ['tweet_pgh','tweet_sf','tweet_ny','tweet_houston','tweet_cleveland','tweet_seattle','tweet_miami','tweet_detroit','tweet_chicago','tweet_london','tweet_minneapolis']
